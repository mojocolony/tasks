...
Upload the contents of this folder to the existing Tasks GitHub Pages repository root. The service worker cache is versioned as `tasks-v13`, so the new build will replace earlier cached assets.
